...
public class DeletedKeysApi {
     ...
     */
    public com.squareup.okhttp.Call getDeletedKeyCall(
            String keyName,
            String apiVersion,
    ...
    private com.squareup.okhttp.Call getDeletedKeyValidateBeforeCall(
            String keyName,
            String apiVersion,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
        ...
        if (keyName == null) {
            throw new ApiException(
                    "Missing the required parameter 'keyName' when calling getDeletedKey(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException(
                    "Missing the required parameter 'apiVersion' when calling getDeletedKey(Async)");
        }

        com.squareup.okhttp.Call call =
                getDeletedKeyCall(keyName, apiVersion, progressListener, progressRequestListener);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DeletedKeyBundle> getDeletedKeyWithHttpInfo(
            String keyName, String apiVersion) throws ApiException {
        com.squareup.okhttp.Call call =
                getDeletedKeyValidateBeforeCall(keyName, apiVersion, null, null);
     ...
     */
    public com.squareup.okhttp.Call getDeletedKeyAsync(
        ...
        com.squareup.okhttp.Call call =
                getDeletedKeyValidateBeforeCall(
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getDeletedKeysCall(
            String apiVersion,
            Integer maxresults,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getDeletedKeysValidateBeforeCall(
            String apiVersion,
            Integer maxresults,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
        ...
        if (apiVersion == null) {
            throw new ApiException(
                    "Missing the required parameter 'apiVersion' when calling getDeletedKeys(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public DeletedKeyListResult getDeletedKeys(String apiVersion, Integer maxresults)
            throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DeletedKeyListResult> getDeletedKeysWithHttpInfo(
            String apiVersion, Integer maxresults) throws ApiException {
        com.squareup.okhttp.Call call =
                getDeletedKeysValidateBeforeCall(apiVersion, maxresults, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getDeletedKeysAsync(
            String apiVersion, Integer maxresults, final ApiCallback<DeletedKeyListResult> callback)
            throws ApiException {
        ...
        com.squareup.okhttp.Call call =
                getDeletedKeysValidateBeforeCall(
                        apiVersion, maxresults, progressListener, progressRequestListener);
        Type localVarReturnType = TypeToken.get(DeletedKeyListResult.class).getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call purgeDeletedKeyCall(
            String keyName,
            String apiVersion,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call purgeDeletedKeyValidateBeforeCall(
            String keyName,
            String apiVersion,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
        ...
        if (keyName == null) {
            throw new ApiException(
                    "Missing the required parameter 'keyName' when calling purgeDeletedKey(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException(
                    "Missing the required parameter 'apiVersion' when calling purgeDeletedKey(Async)");
        }

        com.squareup.okhttp.Call call =
                purgeDeletedKeyCall(keyName, apiVersion, progressListener, progressRequestListener);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> purgeDeletedKeyWithHttpInfo(String keyName, String apiVersion)
            throws ApiException {
        com.squareup.okhttp.Call call =
                purgeDeletedKeyValidateBeforeCall(keyName, apiVersion, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call purgeDeletedKeyAsync(
            String keyName, String apiVersion, final ApiCallback<Void> callback)
            throws ApiException {
        ...
        com.squareup.okhttp.Call call =
                purgeDeletedKeyValidateBeforeCall(
                        keyName, apiVersion, progressListener, progressRequestListener);
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call recoverDeletedKeyCall(
            String keyName,
            String apiVersion,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call recoverDeletedKeyValidateBeforeCall(
            String keyName,
            String apiVersion,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
        ...
        if (keyName == null) {
            throw new ApiException(
                    "Missing the required parameter 'keyName' when calling recoverDeletedKey(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException(
                    "Missing the required parameter 'apiVersion' when calling recoverDeletedKey(Async)");
        }

        com.squareup.okhttp.Call call =
                recoverDeletedKeyCall(
                        keyName, apiVersion, progressListener, progressRequestListener);
        return call;
    }
    ...
    public ApiResponse<KeyBundle> recoverDeletedKeyWithHttpInfo(String keyName, String apiVersion)
            throws ApiException {
        com.squareup.okhttp.Call call =
                recoverDeletedKeyValidateBeforeCall(keyName, apiVersion, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call recoverDeletedKeyAsync(
            String keyName, String apiVersion, final ApiCallback<KeyBundle> callback)
            throws ApiException {
        ...
        com.squareup.okhttp.Call call =
                recoverDeletedKeyValidateBeforeCall(
                        keyName, apiVersion, progressListener, progressRequestListener);
        Type localVarReturnType = TypeToken.get(KeyBundle.class).getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
