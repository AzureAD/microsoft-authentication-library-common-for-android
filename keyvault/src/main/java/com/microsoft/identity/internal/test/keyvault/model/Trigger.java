...
public class Trigger {
     ...
     **/
    @ApiModelProperty(
            value = "Percentage of lifetime at which to trigger. Value should be between 1 and 99.")
    ...
    public String toString() {
        ...
        sb.append("    lifetimePercentage: ")
                .append(toIndentedString(lifetimePercentage))
                .append("\n");
