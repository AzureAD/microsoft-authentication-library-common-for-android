...
public class ConfigApi {
    ...
    private com.squareup.okhttp.Call apiConfigGetValidateBeforeCall(
            String usertype,
            String userrole,
            String mfa,
            String protectionpolicy,
     ...
     */
    public List<ConfigInfo> apiConfigGet(
            String usertype,
            String userrole,
            String mfa,
            String protectionpolicy,
            ...
            String tokenlifetime)
            throws ApiException {
        ApiResponse<List<ConfigInfo>> resp =
                apiConfigGetWithHttpInfo(
                        usertype,
                        userrole,
                        mfa,
                        protectionpolicy,
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<ConfigInfo>> apiConfigGetWithHttpInfo(
            String usertype,
            String userrole,
            String mfa,
            String protectionpolicy,
            ...
            throws ApiException {
        com.squareup.okhttp.Call call =
                apiConfigGetValidateBeforeCall(
                        usertype,
                        userrole,
                        mfa,
                        protectionpolicy,
        ...
        Type localVarReturnType =
                TypeToken.getParameterized(List.class, ConfigInfo.class).getType();
     ...
     */
    public com.squareup.okhttp.Call apiConfigGetAsync(
            String usertype,
            String userrole,
            String mfa,
            String protectionpolicy,
            ...
            String tokentype,
            String tokenlifetime,
            final ApiCallback<List<ConfigInfo>> callback)
            throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call apiConfigUpnGetCall(
            String upn,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call apiConfigUpnGetValidateBeforeCall(
            String upn,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException {
        ...
        if (upn == null) {
            throw new ApiException(
                    "Missing the required parameter 'upn' when calling apiConfigUpnGet(Async)");
        }

        com.squareup.okhttp.Call call =
                apiConfigUpnGetCall(upn, progressListener, progressRequestListener);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<ConfigInfo>> apiConfigUpnGetWithHttpInfo(String upn)
            throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call apiConfigUpnGetAsync(
            String upn, final ApiCallback<List<ConfigInfo>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call =
                apiConfigUpnGetValidateBeforeCall(upn, progressListener, progressRequestListener);
        Type localVarReturnType =
                TypeToken.getParameterized(List.class, ConfigInfo.class).getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
