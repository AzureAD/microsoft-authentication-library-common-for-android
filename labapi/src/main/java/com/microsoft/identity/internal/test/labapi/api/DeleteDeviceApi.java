...
public class DeleteDeviceApi {
     ...
     */
    public com.squareup.okhttp.Call apiDeleteDeviceDeleteCall(
            String upn,
            String deviceid,
    ...
    private com.squareup.okhttp.Call apiDeleteDeviceDeleteValidateBeforeCall(
            String upn,
            String deviceid,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
        ...
        com.squareup.okhttp.Call call =
                apiDeleteDeviceDeleteCall(upn, deviceid, progressListener, progressRequestListener);
        return call;
    }
     ...
     */
    public CustomSuccessResponse apiDeleteDeviceDelete(String upn, String deviceid)
            throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CustomSuccessResponse> apiDeleteDeviceDeleteWithHttpInfo(
            String upn, String deviceid) throws ApiException {
        com.squareup.okhttp.Call call =
                apiDeleteDeviceDeleteValidateBeforeCall(upn, deviceid, null, null);
     ...
     */
    public com.squareup.okhttp.Call apiDeleteDeviceDeleteAsync(
            String upn, String deviceid, final ApiCallback<CustomSuccessResponse> callback)
            throws ApiException {
        ...
        com.squareup.okhttp.Call call =
                apiDeleteDeviceDeleteValidateBeforeCall(
                        upn, deviceid, progressListener, progressRequestListener);
        Type localVarReturnType = TypeToken.get(CustomSuccessResponse.class).getType();
