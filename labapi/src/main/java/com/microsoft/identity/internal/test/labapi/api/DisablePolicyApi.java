...
public class DisablePolicyApi {
     ...
     */
    public com.squareup.okhttp.Call apiDisablePolicyPutCall(
            String upn,
            String policy,
        ...
        if (policy != null) localVarQueryParams.addAll(apiClient.parameterToPair("policy", policy));
    ...
    private com.squareup.okhttp.Call apiDisablePolicyPutValidateBeforeCall(
            String upn,
            String policy,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
        ...
        com.squareup.okhttp.Call call =
                apiDisablePolicyPutCall(upn, policy, progressListener, progressRequestListener);
        return call;
    }
     ...
     */
    public CustomSuccessResponse apiDisablePolicyPut(String upn, String policy)
            throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CustomSuccessResponse> apiDisablePolicyPutWithHttpInfo(
            String upn, String policy) throws ApiException {
        com.squareup.okhttp.Call call =
                apiDisablePolicyPutValidateBeforeCall(upn, policy, null, null);
     ...
     */
    public com.squareup.okhttp.Call apiDisablePolicyPutAsync(
            String upn, String policy, final ApiCallback<CustomSuccessResponse> callback)
            throws ApiException {
        ...
        com.squareup.okhttp.Call call =
                apiDisablePolicyPutValidateBeforeCall(
                        upn, policy, progressListener, progressRequestListener);
        Type localVarReturnType = TypeToken.get(CustomSuccessResponse.class).getType();
