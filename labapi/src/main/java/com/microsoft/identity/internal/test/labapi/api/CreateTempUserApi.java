...
public class CreateTempUserApi {
     ...
     */
    public com.squareup.okhttp.Call apiCreateTempUserPostCall(
            String usertype,
    ...
    private com.squareup.okhttp.Call apiCreateTempUserPostValidateBeforeCall(
            String usertype,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException {
        ...
        com.squareup.okhttp.Call call =
                apiCreateTempUserPostCall(usertype, progressListener, progressRequestListener);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TempUser> apiCreateTempUserPostWithHttpInfo(String usertype)
            throws ApiException {
        com.squareup.okhttp.Call call =
                apiCreateTempUserPostValidateBeforeCall(usertype, null, null);
     ...
     */
    public com.squareup.okhttp.Call apiCreateTempUserPostAsync(
            String usertype, final ApiCallback<TempUser> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call =
                apiCreateTempUserPostValidateBeforeCall(
                        usertype, progressListener, progressRequestListener);
        Type localVarReturnType = TypeToken.get(TempUser.class).getType();
