...
public class LabApi {
     ...
     */
    public com.squareup.okhttp.Call apiLabLabnameGetCall(String labname, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call apiLabLabnameGetValidateBeforeCall(String labname, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'labname' is set
        if (labname == null) {
            throw new ApiException("Missing the required parameter 'labname' when calling apiLabLabnameGet(Async)");
        }
        
        com.squareup.okhttp.Call call = apiLabLabnameGetCall(labname, progressListener, progressRequestListener);
        return call;
     ...
     */
    public com.squareup.okhttp.Call apiLabLabnameGetAsync(String labname, final ApiCallback<List<LabInfo>> callback) throws ApiException {
