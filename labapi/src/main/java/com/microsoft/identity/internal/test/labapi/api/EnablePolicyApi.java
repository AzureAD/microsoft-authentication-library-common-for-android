...
public class EnablePolicyApi {
     ...
     */
    public com.squareup.okhttp.Call apiEnablePolicyPutCall(
            String upn,
            String policy,
    ...
    private com.squareup.okhttp.Call apiEnablePolicyPutValidateBeforeCall(
            String upn,
            String policy,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
        ...
        com.squareup.okhttp.Call call =
                apiEnablePolicyPutCall(upn, policy, progressListener, progressRequestListener);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CustomSuccessResponse> apiEnablePolicyPutWithHttpInfo(
            String upn, String policy) throws ApiException {
        com.squareup.okhttp.Call call =
                apiEnablePolicyPutValidateBeforeCall(upn, policy, null, null);
     ...
     */
    public com.squareup.okhttp.Call apiEnablePolicyPutAsync(
        ...
        com.squareup.okhttp.Call call =
                apiEnablePolicyPutValidateBeforeCall(
