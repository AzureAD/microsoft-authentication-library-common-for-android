...
public class ResetApi {
     ...
     */
    public com.squareup.okhttp.Call apiResetPutCall(
            String upn,
            String operation,
    ...
    private com.squareup.okhttp.Call apiResetPutValidateBeforeCall(
            String upn,
            String operation,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
        ...
        com.squareup.okhttp.Call call =
                apiResetPutCall(upn, operation, progressListener, progressRequestListener);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CustomSuccessResponse> apiResetPutWithHttpInfo(String upn, String operation)
            throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call apiResetPutAsync(
            String upn, String operation, final ApiCallback<CustomSuccessResponse> callback)
            throws ApiException {
        ...
        com.squareup.okhttp.Call call =
                apiResetPutValidateBeforeCall(
                        upn, operation, progressListener, progressRequestListener);
        Type localVarReturnType = TypeToken.get(CustomSuccessResponse.class).getType();
