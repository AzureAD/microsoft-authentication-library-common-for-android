...
public class LabPolicyInfoApi {
    ...
    /**
     * Build call for getLabPolicyInfo
     *
     ...
     */
    public com.squareup.okhttp.Call getLabPolicyInfoCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getLabPolicyInfoValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {


        com.squareup.okhttp.Call call = getLabPolicyInfoCall(progressListener, progressRequestListener);
        return call;
     ...
     */
    public CustomSuccessResponse getLabPolicyInfo() throws ApiException {
        ApiResponse<CustomSuccessResponse> resp = getLabPolicyInfoWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CustomSuccessResponse> getLabPolicyInfoWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getLabPolicyInfoValidateBeforeCall(null, null);
     ...
     */
    public com.squareup.okhttp.Call getLabPolicyInfoAsync(final ApiCallback<CustomSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getLabPolicyInfoValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CustomSuccessResponse>() {
        }.getType();
