...
public class LabPolicyInfoApi {
     ...
     */
    public com.squareup.okhttp.Call apiLabPolicyInfoGetCall(
    ...
    private com.squareup.okhttp.Call apiLabPolicyInfoGetValidateBeforeCall(
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException {

        com.squareup.okhttp.Call call =
                apiLabPolicyInfoGetCall(progressListener, progressRequestListener);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CustomSuccessResponse> apiLabPolicyInfoGetWithHttpInfo()
            throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call apiLabPolicyInfoGetAsync(
            final ApiCallback<CustomSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call =
                apiLabPolicyInfoGetValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = TypeToken.get(CustomSuccessResponse.class).getType();
