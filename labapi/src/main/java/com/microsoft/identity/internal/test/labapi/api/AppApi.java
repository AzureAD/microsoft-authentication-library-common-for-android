...
public class AppApi {
     ...
     */
    public com.squareup.okhttp.Call apiAppAppidGetCall(
            String appid,
        ...
        String localVarPath =
                "/api/App/{appid}"
                        .replaceAll(
                                "\\{" + "appid" + "\\}", apiClient.escapeString(appid.toString()));
    ...
    private com.squareup.okhttp.Call apiAppAppidGetValidateBeforeCall(
            String appid,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException {
        ...
        if (appid == null) {
            throw new ApiException(
                    "Missing the required parameter 'appid' when calling apiAppAppidGet(Async)");
        }

        com.squareup.okhttp.Call call =
                apiAppAppidGetCall(appid, progressListener, progressRequestListener);
        return call;
    }
     ...
     */
    public com.squareup.okhttp.Call apiAppAppidGetAsync(
            String appid, final ApiCallback<List<AppInfo>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call =
                apiAppAppidGetValidateBeforeCall(appid, progressListener, progressRequestListener);
        Type localVarReturnType = TypeToken.getParameterized(List.class, AppInfo.class).getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call apiAppGetCall(
            String apptype,
            String azureenvironment,
            String signinaudience,
            String isadminconsented,
            String publicclient,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException {
        ...
        if (isadminconsented != null)
            localVarQueryParams.addAll(
                    apiClient.parameterToPair("isadminconsented", isadminconsented));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call apiAppGetValidateBeforeCall(
            String apptype,
            String azureenvironment,
            String signinaudience,
            String isadminconsented,
    ...
    public List<AppInfo> apiAppGet(
            ...
            String publicclient)
            throws ApiException {
        ApiResponse<List<AppInfo>> resp =
                apiAppGetWithHttpInfo(
                        apptype, azureenvironment, signinaudience, isadminconsented, publicclient);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<AppInfo>> apiAppGetWithHttpInfo(
            String apptype,
            String azureenvironment,
            String signinaudience,
            String isadminconsented,
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call apiAppGetAsync(
            String apptype,
            String azureenvironment,
            String signinaudience,
            String isadminconsented,
            String publicclient,
            final ApiCallback<List<AppInfo>> callback)
            throws ApiException {
